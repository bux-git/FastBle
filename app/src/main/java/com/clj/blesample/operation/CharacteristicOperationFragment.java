                            ...
                            BleManager.getInstance().read(
                                    ...
                                    new BleReadCallback() {
                                        ...
                                        public void onReadSuccess(final byte[] data) {
                                            Log.d(TAG, "onReadSuccess: " + new String(data));
                                            runOnUiThread(new Runnable() {
                                                ...
                                                public void run() {
                                                    ...
                                                    addText(txt, new String(data));//HexUtil.formatHexString(data, true)
                                                }
                                            });
                                        }
                                            ...
                                            public void onCharacteristicChanged(final byte[] data) {
                                                runOnUiThread(new Runnable() {
                                                    ...
                                                    public void run() {
                                                        ...
                                                        addText(txt, result + "    strLength:" + result.length() + "   byteLength:" + data.length);
                                                    }
                                                });
                                            }
                                        });
